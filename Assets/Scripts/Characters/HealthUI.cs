...
public sealed class HealthUI : Health
{
	...
	/// </summary>
	public override bool Decrement(GameObject source, GameObject directCause, float amount, DamageType type)
	{
		bool changed = base.Decrement(source, directCause, amount, type);
		if (!changed)
		{
			return false;
		}
