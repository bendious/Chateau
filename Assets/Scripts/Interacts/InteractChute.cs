...
public class InteractChute : MonoBehaviour, IInteractable
{
	...
	{
		GameController.Instance.m_dialogueController.Play(m_dialogue.m_dialogue.RandomWeighted().m_lines, character: interactor.GetComponent<KinematicCharacter>(), expressions: m_dialogue.m_expressions);
	}
}
