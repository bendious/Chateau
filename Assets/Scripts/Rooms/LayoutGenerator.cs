...
public class LayoutGenerator
{
	public class Node
	{
		...
		public bool IsOptional {
			get {
				Node downstreamExit = FindDescendant(n => n.m_type == Type.ExitDoor1 || n.m_type == Type.ExitDoor2 || n.m_type == Type.ExitDoor3 || n.m_type == Type.ExitDoor4 || n.m_type == Type.ExitDoor5); // TODO: handle multiple separate exits?
	...
	private static readonly ReplacementRule[] m_rules =
	{
		...
		new(Node.Type.Basement, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomDown, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomDown, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomDown) }) }) }) }) }) }),
		new(Node.Type.Tower, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomUp, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomUp, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomUp, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomUp) }) }) }) }) }) }) }) }),
