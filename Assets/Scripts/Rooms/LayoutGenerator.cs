...
public class LayoutGenerator
{
	...
	private static readonly ReplacementRule[] m_rules =
	{
		...
		new(Node.Type.Entryway, new() { new(Node.Type.Entrance, Node.Multiparents(new() { new(Node.Type.AreaDivider, new() { new(Node.Type.Room, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.ExitDoor, new() { new(Node.Type.LockOrdered, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.ExitDoor, new() { new(Node.Type.LockOrdered, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomDown, new() { new(Node.Type.ExitDoor, new() { new(Node.Type.LockOrdered, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.RoomUp, new() { new(Node.Type.ExitDoor) }) }) }) }) }) }) }) }) }) }) }) }) }) }), new(Node.Type.Basement, new() { new(Node.Type.Secret, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.RoomIndefiniteCorrect, new() { new(Node.Type.Secret) }) }) }) }), new(Node.Type.Tower), new(Node.Type.Corridor) }, new(Node.Type.Npc, new() { new(Node.Type.Npc), new(Node.Type.Npc), new(Node.Type.Npc), new(Node.Type.FinalHintSequence) }))) }), // TODO: move directional lock requirements & NPC count into data?
		new(Node.Type.Zone1, new() { new(Node.Type.Entrance, new() { new(Node.Type.SequenceSmall, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceSmall, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceMedium, new() { new(Node.Type.SecretHintGroup), new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.Boss, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.Npc), new(Node.Type.ExitDoor), new(Node.Type.ExitDoor), new(Node.Type.FinalHint) }) }) }) }) }) }) }) }) }) }) }),
		new(Node.Type.Zone2, new() { new(Node.Type.Entrance, new() { new(Node.Type.SequenceSmall, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceMedium, new() { new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceLarge, new() { new(Node.Type.SecretHintGroup), new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.Boss, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.Npc), new(Node.Type.ExitDoor), new(Node.Type.ExitDoor), new(Node.Type.FinalHint) }) }) }) }) }) }) }) }) }) }) }) }),
		new(Node.Type.Zone3, new() { new(Node.Type.Entrance, new() { new(Node.Type.SequenceSmall, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceMedium, new() { new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceExtraLarge, new() { new(Node.Type.SecretHintGroup), new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.Boss, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.Npc), new(Node.Type.ExitDoor), new(Node.Type.ExitDoor), new(Node.Type.FinalHint) }) }) }) }) }) }) }) }) }) }) }) }),
		new(Node.Type.Zone4, new() { new(Node.Type.Entrance, new() { new(Node.Type.SequenceSmall, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceMedium, new() { new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceLarge, new() { new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.SequenceExtraLarge, new() { new(Node.Type.SecretHintGroup), new(Node.Type.Lock, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.Boss, new() { new(Node.Type.TightCoupling, new() { new(Node.Type.Npc), new(Node.Type.ExitDoor), new(Node.Type.FinalHint) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }),
		...
		new(Node.Type.SequenceSmall, new() { new(Node.Type.Key, new() { new(Node.Type.Lock) }) }),
		new(Node.Type.SequenceMedium, new() { new(Node.Type.Key), new(Node.Type.Key) }),
		...
		new(Node.Type.SecretHintGroup, new() { new(Node.Type.Secret, new() { new(Node.Type.AreaDivider, new() { new(Node.Type.RoomSecret), new(Node.Type.FinalHint) }) }) }),
